...
top_n3 = mtr.set_top_n(ranking_jml_bobot3,500)
...
top_n2 = mtr.set_top_n(ranking_jml_bobot2,2500)
...
top_n0 = mtr.set_top_n(ranking_jml_bobot0,7000)

print "layer visible"
print 'hasil perankingan top 250 visible 7k 10k 5k 1k: '
